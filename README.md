...
* ### `[GET] - /attendees`: List all attendees
  ...
  ```
* ### `[GET] - /attendees?fields=query1,..`: List all attendees by some fields
...
* ### `[GET] - /attendee/{id}`: Get attendee's information
  ...
  **Example**
  ...
  ```
* ### `[GET] - /attendee/{id}?fields=query1,..`: Get attendee's information by some fields
...
* ### `[GET] - /speakers`: List all speakers
  ...
  **Example**
  ...
  ```
* ### `[GET] - /speakers?fields=query1,..`: List all speakers by some fields
...
```json
  ...
  ```
* ### `[GET] - /speakers?sortAsc=field`: List and sort all attendees in ascending order by some fields
